...
<template>
	...
	<div class="flex gap-4 sticky top-5">
		<div
		...
		<div
			@click="toggleDark"
			class="bg-white dark:bg-neutral-950 flex justify-center items-center h-10 w-10 border rounded-full shadow-lg cursor-pointer"
		>
			<component
				:is="isDark ? IconLight : IconDark"
